...
-   Clone the repo: `https://github.com/TedyPermana24/apotek.git`
...
Read the [documentation page](https://docs.getstisla.com/#/en/2.2.0/overview) for more information on the framework contents, templates and examples, and more.
